<template>
  <div class="big-container screen-wrap">
    ...
    <!-- 疫苗接种、核酸检测 -->
    <MobileDialog
      v-if="[6, 7, 9, 10, 11, 12, 13, 14, 'publicOpinion','dataSpecification','volunteer'].includes(layer)"
      :layer="layer"
      @close="layer = 0"
    />
...
export default {
  ...
  data() {
    return {
      ...
      zIndex: 1,
      showPlaceMap: false,
      layer: 20, //当前图层: 0 默认地图， 1公安流调  3嘉安花园， 4封控管理区，5流调数据总览,6疫苗接种,7核酸检测 8数据说明,12 人员核查
