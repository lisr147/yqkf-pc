...
<script>
// import './AliPlayer.js'
// g.alicdn.com/de/prismplayer/2.9.16/aliplayer-min.js
let playerScriptTag = document.getElementById('playerScriptTag')
// 如果这个tag不存在，则生成相关代码tag以加载代码
if (playerScriptTag === null) {
  playerScriptTag = document.createElement('script')
  playerScriptTag.type = 'text/javascript'
  playerScriptTag.src = '//g.alicdn.com/de/prismplayer/2.9.16/aliplayer-min.js'
  playerScriptTag.id = 'playerScriptTag'
  let s = document.getElementsByTagName('head')[0]
  s.appendChild(playerScriptTag)
  console.log('阿里播放器SDK加载')
}
...
export default {
  ...
  methods: {
    initAliplayer () {
      ...
      let instance = document.querySelector('#' + _this.playerId)
      if (instance) {
        instance.innerHTML = ''
      }
      ...
      _this.$nextTick(() => {
        ...
        // console.log('aliplayer', _this.instance)
        _this.instance._monitor.trackLog = false
        // _this.instance._monitor._logService._logReportTo = ''
        _this.instance._options.flvOption.hasAudio = false
        // _this.instance._options.logBatched = false
